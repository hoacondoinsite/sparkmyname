...
function cineSVG(C,seed){var id='cn'+slug(seed),s=hashN(seed);var c0=C[0],c1=C[1],c2=(C[2]||'#141414'),c3=(C[3]||C[1]);
 return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 180" preserveAspectRatio="xMidYMid slice" role="img" aria-label="Cinematic brand photo"><defs>'+
