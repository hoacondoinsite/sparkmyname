...
function domainOntology(industry){
  ...
  const map=[
    ...
    [['funeral','memorial'],{scene:'A serene, dignified chapel interior: elegant stone arches, polished wooden pews, soft natural daylight through tall arched windows, tasteful white and cream floral arrangements, warm, solemn and peaceful, with absolutely no casket, coffin, or human figures',physics:'soft architectural daylight, quiet stillness, gentle warm tones',surface:'arranged with quiet dignity'}],
